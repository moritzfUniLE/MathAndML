...
- **Extensive Datasets**: 20+ built-in datasets from synthetic and real-world sources
...
```
This will check all dependencies and launch the web interface. All 20 datasets (including bnlearn datasets) are pre-loaded and ready to use.
...
- `conglomeratedData` - Protein signaling (11 variables)
...
- **notears_web_gui.py**: Main web application with built-in dependency checking
...
├── notears_web_gui.py            # Main web application with launcher
